...
export class SpeakRequest extends jspb.Message {
  ...
  getVoice(): SpeakRequest.VoiceMap[keyof SpeakRequest.VoiceMap];
  setVoice(value: SpeakRequest.VoiceMap[keyof SpeakRequest.VoiceMap]): void;
...
export namespace SpeakRequest {
  export type AsObject = {
    text: string,
    voice: SpeakRequest.VoiceMap[keyof SpeakRequest.VoiceMap],
  }
